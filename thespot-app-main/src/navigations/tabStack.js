...
const MyTabs = ({ route }) => {
    ...
    return (
        ...
        >
            <Tab.Screen   name="Profile" component={HomeStack} options={({ route }) => ({ tabBarVisible: getTabBarVisibility(route) }),{unmountOnBlur: true}} />
            <Tab.Screen name="Location" component={LocationStack} options={({ route }) => ({ tabBarVisible: getTabBarVisibility(route) }),options={unmountOnBlur: true} } />
