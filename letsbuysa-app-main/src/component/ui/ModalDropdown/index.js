...
export default class ModalDropdown extends Component {
    ...
    _calcPosition() {
        ...
        const optLength = Array.isArray(options) && options.length < 5 ? options.length : 5;
        const dropdownHeight = (dropdownStyle && StyleSheet.flatten(dropdownStyle).height) ||
            ((33 + StyleSheet.hairlineWidth) * optLength);
        ...
        if (showInLeft) {
            positionStyle.left = I18nManager.isRTL ?
                windowWidth - (this._buttonFrame.x + this._buttonFrame.w) :
                this._buttonFrame.x;
        } else {
            ...
            positionStyle.right = I18nManager.isRTL ?
                this._buttonFrame.x :
