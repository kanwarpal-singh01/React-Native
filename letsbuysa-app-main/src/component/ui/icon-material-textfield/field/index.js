...
export default class TextField extends PureComponent {
    ...
    render() {
        ...
        let titleFontSizeMultiplier = helpersNumberOfLines;
        ...
        return (
            <View {...containerProps}>
                <Animated.View {...inputContainerProps}>
                    ...
                    <Label {...labelProps} iconSize={this.props.showIcon ? this.props.iconSize : 0}>{label}</Label>

                    <View style={styles.row}>
                        {this.renderAffix('prefix', active, focused)}
                        {this.props.showIcon &&
                        <Icon
                            style={{top: 8, marginEnd: this.props.showFlag ? 5 : 10}}
                        ...
                        <Image
                            ...
                            source={{uri: this.props.showFlag}}
                            resizeMode='contain'/>
                        }
                        <TextInput
